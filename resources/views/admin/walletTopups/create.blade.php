...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.walletTopup.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.wallet-topups.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gateway_ref') ? 'is-invalid' : '' }}" type="text" name="gateway_ref" id="gateway_ref" value="{{ old('gateway_ref', '') }}">
