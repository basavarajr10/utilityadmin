...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.mobileRecharge.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.mobile-recharges.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('operator') ? 'is-invalid' : '' }}" type="text" name="operator" id="operator" value="{{ old('operator', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('circle') ? 'is-invalid' : '' }}" type="text" name="circle" id="circle" value="{{ old('circle', '') }}">
