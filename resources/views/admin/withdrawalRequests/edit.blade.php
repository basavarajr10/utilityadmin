    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.withdrawal-requests.update", [$withdrawalRequest->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('customer') ? 'is-invalid' : '' }}" name="customer_id" id="customer_id" required>
                    @foreach($customers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('customer_id') ? old('customer_id') : $withdrawalRequest->customer->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="text" name="amount" id="amount" value="{{ old('amount', $withdrawalRequest->amount) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_name') ? 'is-invalid' : '' }}" type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $withdrawalRequest->bank_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_number') ? 'is-invalid' : '' }}" type="text" name="account_number" id="account_number" value="{{ old('account_number', $withdrawalRequest->account_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ifsc_code') ? 'is-invalid' : '' }}" type="text" name="ifsc_code" id="ifsc_code" value="{{ old('ifsc_code', $withdrawalRequest->ifsc_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('upi') ? 'is-invalid' : '' }}" type="text" name="upi" id="upi" value="{{ old('upi', $withdrawalRequest->upi) }}">
                @if($errors->has('upi'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('admin_note') ? 'is-invalid' : '' }}" name="admin_note" id="admin_note">{!! old('admin_note', $withdrawalRequest->admin_note) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('processed_at') ? 'is-invalid' : '' }}" type="text" name="processed_at" id="processed_at" value="{{ old('processed_at', $withdrawalRequest->processed_at) }}">
