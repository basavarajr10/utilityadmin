...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.dthRecharge.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.dth-recharges.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subscriber') ? 'is-invalid' : '' }}" type="text" name="subscriber" id="subscriber" value="{{ old('subscriber', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pack_name') ? 'is-invalid' : '' }}" type="text" name="pack_name" id="pack_name" value="{{ old('pack_name', '') }}">
