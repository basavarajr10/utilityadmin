...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-CommissionSetting">
            <thead>
                <tr>
                    <th width="10">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            ...
                            @foreach(App\Models\CommissionSetting::SERVICE_TYPE_SELECT as $key => $item)
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.commission-settings.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'service_type', name: 'service_type' },
{ data: 'commission_pct', name: 'commission_pct' },
{ data: 'min_commission', name: 'min_commission' },
{ data: 'max_commission', name: 'max_commission' },
{ data: 'flat_charge', name: 'flat_charge' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-CommissionSetting').DataTable(dtOverrideGlobals);
