    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.commission-settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('service_type') ? 'is-invalid' : '' }}" name="service_type" id="service_type" required>
                    ...
                    @foreach(App\Models\CommissionSetting::SERVICE_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('service_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commission_pct') ? 'is-invalid' : '' }}" type="text" name="commission_pct" id="commission_pct" value="{{ old('commission_pct', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_commission') ? 'is-invalid' : '' }}" type="text" name="min_commission" id="min_commission" value="{{ old('min_commission', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_commission') ? 'is-invalid' : '' }}" type="text" name="max_commission" id="max_commission" value="{{ old('max_commission', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('flat_charge') ? 'is-invalid' : '' }}" type="text" name="flat_charge" id="flat_charge" value="{{ old('flat_charge', '') }}">
