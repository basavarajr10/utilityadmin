...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.busBooking.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.bus-bookings.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('booking') ? 'is-invalid' : '' }}" type="text" name="booking" id="booking" value="{{ old('booking', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('destination') ? 'is-invalid' : '' }}" type="text" name="destination" id="destination" value="{{ old('destination', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('travel_date') ? 'is-invalid' : '' }}" type="text" name="travel_date" id="travel_date" value="{{ old('travel_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seats') ? 'is-invalid' : '' }}" type="text" name="seats" id="seats" value="{{ old('seats', '') }}" required>
                @if($errors->has('seats'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('passenger_details') ? 'is-invalid' : '' }}" type="text" name="passenger_details" id="passenger_details" value="{{ old('passenger_details', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('api_ref') ? 'is-invalid' : '' }}" type="text" name="api_ref" id="api_ref" value="{{ old('api_ref', '') }}">
