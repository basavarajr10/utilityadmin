...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.billTransaction.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.bill-transactions.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('txn') ? 'is-invalid' : '' }}" type="text" name="txn" id="txn" value="{{ old('txn', '') }}" required>
                @if($errors->has('txn'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('biller_name') ? 'is-invalid' : '' }}" type="text" name="biller_name" id="biller_name" value="{{ old('biller_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('consumer_number') ? 'is-invalid' : '' }}" type="text" name="consumer_number" id="consumer_number" value="{{ old('consumer_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bbps_ref') ? 'is-invalid' : '' }}" type="text" name="bbps_ref" id="bbps_ref" value="{{ old('bbps_ref', '') }}">
