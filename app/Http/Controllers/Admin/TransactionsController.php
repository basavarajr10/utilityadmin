...
class TransactionsController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Transaction::with(['customer'])->select(sprintf('%s.*', (new Transaction)->table));
            ...
            $table->editColumn('commission_earned', function ($row) {
                return $row->commission_earned ? $row->commission_earned : '';
            });
        ...
        return view('admin.transactions.index', compact('customers'));
    }
    ...
    public function edit(Transaction $transaction)
    {
        ...
        return view('admin.transactions.edit', compact('customers', 'transaction'));
    }
