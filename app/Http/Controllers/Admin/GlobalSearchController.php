...
class GlobalSearchController extends Controller
{
    private $models = [
        ...
        'KycRequest'        => 'cruds.kycRequest.title',
        'MobileRecharge'    => 'cruds.mobileRecharge.title',
        'BillTransaction'   => 'cruds.billTransaction.title',
        'BusBooking'        => 'cruds.busBooking.title',
        'WalletTopup'       => 'cruds.walletTopup.title',
        'WithdrawalRequest' => 'cruds.withdrawalRequest.title',
        'Transaction'       => 'cruds.transaction.title',
    ];
